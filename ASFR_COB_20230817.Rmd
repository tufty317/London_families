...
```{r fig_London_TFR_B, fig.height = 5.56, fig.width = 9,  echo=FALSE, warning=FALSE, message=FALSE}


TFR_line_time_rep <- TFR_data_long_label %>%
  filter(Location_factor != "All women") %>%
  ggplot(aes(x = Year_new, y = TFR, group = Location_factor, colour = Location_factor, 
                                                text = paste("Year  :", Year_new,
                                                          "<br>Location of birth : ", Location,
...
ggsave (filename = "C:/Families/Charts_for_Daryl/21_N_TFR_COB_line.svg",
         plot = TFR_line_time_rep,
         device = "svg",
         dpi=600,
         width = 9,
         height = 5.56,
