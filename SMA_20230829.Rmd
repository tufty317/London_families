...
SMA_London_zone_EandW_lines <-
   ggplot() +
  theme_gla() +
  geom_line(data = SMA_Inner_London, aes(x = year_factor, y = SMA,  group = 1, color = '#d82222' ), size = 2) +
    geom_line(data = SMA_Outer_London, aes(x = year_factor, y = SMA,  group = 1, color = '#6da7de'), size = 2) +
   geom_line(data = SMA_EandW, aes(x = year_factor, y = EandW_SMA, group = 1, color = "#5ea15d"), size = 2) +
  scale_x_discrete(name ="Year", breaks=c("1991", "1996", "2001","2006","2011", "2016", "2021")) +
   scale_color_manual(name="", values=c( "#5ea15d", '#6da7de','#d82222'), labels=c("Rest of England and Wales", "Outer London","Inner London")) +
  theme(legend.position = "right") +
  theme(legend.title=element_text(size=14, family = "Arial"),
        legend.text=element_text(size=11, family = "Arial"),
        axis.text.x=element_text(color = "black", 
