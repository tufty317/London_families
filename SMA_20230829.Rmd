...
SMA_London_zone_EandW_lines <-
   ggplot() +
  theme_gla() +
  geom_line(data = SMA_Inner_London, aes(x = year_factor, y = SMA,  group = 1, color = '#e41a1c' )) +
    geom_line(data = SMA_Outer_London, aes(x = year_factor, y = SMA,  group = 1, color = '#377eb8') ) +
   geom_line(data = SMA_EandW, aes(x = year_factor, y = EandW_SMA, group = 1, color = "green")) +
  scale_x_discrete(name ="Year", breaks=c("1991", "1996", "2001","2006","2011", "2016", "2021")) +
