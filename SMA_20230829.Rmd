...
```{r fig_London_SMA_1, fig.height = 5, fig.width = 9,  echo=FALSE, warning=FALSE, message=FALSE}
...
SMA_London_geog <- London_SMA_allYears_boroughs_zone %>% 
  ...
  mutate(SMA_Cat = cut(lastSMA, breaks = c(30, 31, 32, 33.5, 35),
                             right=FALSE,
                             labels = c(" 30 - 30.99",
                                        " 31 - 31.99",
                                        " 32 - 33.49",
...
SMA_London_map <- SMA_London_geog %>%
  ggplot()+
  ...
  labs(title= "<b>SMA in 2021, London<b>", 
       caption = paste0("Source: Home Office, Chart: GLA demography")) +
  labs(fill = "% change in SMA")

# Interactive map using ggplotly
SMA_London_map_int <- ggplotly(SMA_London_map, tooltip = "text") %>%
  layout(title= list(x = 0.05,
                     text = "<b>Standardised Mean Age of mothers, London, 2021<b>", 
...
```{r fig_London_SMA_2, fig.height = 5, fig.width = 9,  echo=FALSE, warning=FALSE, message=FALSE}
...
```{r fig_London_SMA_3, fig.height = 5, fig.width = 9,  echo=FALSE, warning=FALSE, message=FALSE}
...
```{r fig_London_SMA_4, fig.height = 5, fig.width = 9,  echo=FALSE, warning=FALSE, message=FALSE}
...
```{r fig_London_SMA_5, fig.height = 5, fig.width = 9,  echo=FALSE, warning=FALSE, message=FALSE}
...
```{r fig_London_SMA_6, fig.height = 5, fig.width = 9,  echo=FALSE, warning=FALSE, message=FALSE}
...
```{r fig_London_SMA_7, fig.height = 5, fig.width = 9,  echo=FALSE, warning=FALSE, message=FALSE}
...
```{r fig_London_SMA_8, fig.height = 5, fig.width = 9,  echo=FALSE, warning=FALSE, message=FALSE}
...
```{r fig_London_SMA_9, fig.height = 5, fig.width = 9,  echo=FALSE, warning=FALSE, message=FALSE}
...
SMA_absChange_map2 <- SMA_absChange_geog %>%
  ...
  theme(axis.title.x = element_blank(),
        ...
        axis.ticks.y = element_blank())+
  scale_fill_manual(values = catgreen4) + 
  labs(title= "<b>Change in SMA, 1993 - 2021, London<b>", 
       caption = paste0("Source: Home Office, Chart: GLA demography")) +
  labs(fill = "Change in SMA")
...
```{r fig_London_SMA_11, fig.height = 5, fig.width = 9,  echo=FALSE, warning=FALSE, message=FALSE}
...
SMA_percChange_geog <- London_SMA_allYears_boroughs_zone %>% 
  ...
  mutate(SMA_PercChangeCat = cut(PercChange_SMA, breaks = c(5, 8, 12, 16, 21),
                             right=FALSE,
                             labels = c(" 5 - 7.99",
                                        " 8 - 11.99",
                                        " 12 - 15.99",
...
SMA_percChange_map <- SMA_percChange_geog %>%
  ggplot()+
  geom_point(aes(x=BNG_E, y=BNG_N, 
                 text = paste("Borough: ", gss_name,  
                              "<br>SMA in 1993: ", 
  ...
  theme(axis.title.x = element_blank(),
        ...
        axis.ticks.y = element_blank())+
  scale_fill_manual(values = catgreen4) + 
  labs(title= "<b>Percentage change in SMA, 1993 - 2021, London<b>", 
       caption = paste0("Source: Home Office, Chart: GLA demography")) +
  labs(fill = "% change in SMA")

# Interactive map using ggplotly
SMA_percChange_map_int <- ggplotly(SMA_percChange_map, tooltip = "text") %>%
  layout(title= list(x = 0.05,
