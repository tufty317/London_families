...
# Calculate SMA (not using using method - see line 852 for new method) 
...
# Calculate ASFR for each borough for each borough
...
# Calculate TFR for each borough for each borough
...
```{r fig_London_Eng_ASFR, fig.height = 5, fig.width = 9,  echo=FALSE, warning=FALSE, message=FALSE}
...
```{r fig_London_zone_ASFR, fig.height = 5, fig.width = 9,  echo=FALSE, warning=FALSE, message=FALSE}
...
ASFR_London_line_zone <- London_ASFR_allYears_zone %>%
  ...
  geom_line(aes(x = age_numeric, y = London_zone_ASFR_perK, group = Inner_factor, color = Inner_factor,
             text = paste("Age: ", age_mother,
                          ...
                          "<br>ASFR: ", round(London_zone_ASFR_perK, digits = 2))
  ), size = 1 ) +
  theme_gla() +
  ylim(0, 120) +
...
```{r fig_London_zone_TFR, fig.height = 5, fig.width = 9,  echo=FALSE, warning=FALSE, message=FALSE}
...
```{r fig_London_Eng_TFR, fig.height = 5, fig.width = 9,  echo=FALSE, warning=FALSE, message=FALSE}
...
```{r fig_boroughs_TFR_1, fig.height = 5, fig.width = 9,  echo=FALSE, warning=FALSE, message=FALSE}
...
```{r fig_boroughs_TFR_2, fig.height = 5, fig.width = 9,  echo=FALSE, warning=FALSE, message=FALSE}
...
```{r fig_boroughs_TFR_3, fig.height = 5, fig.width = 9,  echo=FALSE, warning=FALSE, message=FALSE}
...
```{r fig_boroughs_ASFR, fig.height = 5, fig.width = 9,  echo=FALSE, warning=FALSE, message=FALSE}
