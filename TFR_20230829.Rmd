...
ASFR_London_zone_EandW_lines <-
   ggplot() +
  theme_gla() +
  geom_line(data = London_ASFR_allYears_Inner, aes(age_numeric, y = London_zone_ASFR_perK,  group = 1, color = '#e41a1c' )) +
    geom_line(data = London_ASFR_allYears_Outer, aes(age_numeric, y = London_zone_ASFR_perK,  group = 1, color = '#377eb8') ) +
   geom_line(data = EandW_ASFR_allYears, aes(age_numeric, y = EandW_ASFR_perK,  group = 1, color = "green")) +
  theme(plot.title = element_text(size = 16, hjust = 0.5)) +
  theme(legend.position = "right") +
   scale_color_manual(name="Legend:", values=c( '#377eb8','#e41a1c' ,"green"), labels=c("Outer London", "Inner London", "Rest of England and Wales")) +
...
TFR_London_zone_EandW_lines <-
   ggplot() +
  theme_gla() +
  geom_line(data = London_TFR_allYears_Inner, aes(Year, y = London_zone_TFR,  group = 1, color = '#e41a1c' )) +
    geom_line(data = London_TFR_allYears_Outer, aes(Year, y = London_zone_TFR,  group = 1, color = '#377eb8') ) +
   geom_line(data = EandW_TFR_allYears, aes(Year, y = EandW_TFR,  group = 1, color = "green")) +
  ylim(1, 2.4) +
  scale_x_discrete(name ="Year", breaks=c("1991", "1996", "2001","2006","2011", "2016", "2021")) +
  scale_color_manual(name="Geographical area:", values=c( '#377eb8','#e41a1c' ,"green"), labels=c("Outer London", "Inner London", "Rest of England and Wales")) +          theme(legend.position = "right") +
  theme(legend.title=element_text(size=14, family = "Arial"),
        legend.text=element_text(size=11, family = "Arial"),
        axis.text.x=element_text(color = "black", 
                                 size=11, family = "Arial"),  #, angle=30, vjust=.8, hjust=0.8
...
ggsave (filename = (paste0(chart_dir, "SMA_London_change_1993_scatterplot.png")),
...
ggsave (filename = (paste0(chart_dir, "TFR_vSMA_scatterplot.png")),
...
catgreen5 = c('#3f633e', '#578555', '#7aa677', '#a6c6a2', '#d8e4d6')
