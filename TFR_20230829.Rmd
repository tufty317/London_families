...
ASFR_London_zone_EandW_lines <-
  ...
  theme(legend.position = "right") +
   scale_color_manual(name="Legend:", values=c( "#5ea15d", '#6da7de','#d82222'), labels=c("Rest of England and Wales", "Outer London","Inner London")) +
...
TFR_London_zone_EandW_lines <-
  ...
  geom_line(data = London_TFR_allYears_Inner, aes(Year, y = London_zone_TFR,  group = 1, color = '#d82222' ), size = 2) +
   ...
   geom_line(data = EandW_TFR_allYears, aes(Year, y = EandW_TFR,  group = 1, color = "#5ea15d"), size = 2) +
  ylim(1, 2.4) +
  scale_x_discrete(name ="Year", breaks=c("1991", "1996", "2001","2006","2011", "2016", "2021")) +
