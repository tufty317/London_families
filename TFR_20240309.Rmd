---
title: "TFR analysis, March 9 2024"
output: 
  html_document:
    css: Wil_style.css
    theme: default
...
# Recalculating rates on 9 March 2024 to compare zones of London with national average.

# Read in data for all births from 1993 to 2021 in England and Wales, excluding London

EandW_births <- readRDS(paste0(data_dir,"births_calendar_year_age_mother_lad.rds")) %>%         data.frame
...
EandW_female_pop <-  readRDS(paste0(data_dir,"pop_1991_2021_age_0to85plus.rds")) %>% 
  filter(grepl('W06000', gss_code) | grepl('E08000', gss_code) |  grepl('E07000', gss_code) |  grepl('E06000', gss_code) | grepl('E09000', gss_code)) %>%
   filter(year >1992) %>%
   filter(sex == "female") %>%  
   data.frame()
...
## Line plot of ASFR for E and W and London, 2021
...
ASFR_London_allEandW_line <- merged_ASFR_London_EandW %>%
  ggplot() +
  geom_line(aes(x = age_numeric, y = London_ASFR_perK, group = 1, colour = "London", 
   ...
   geom_line(aes(x = age_numeric, y = EandW_ASFR_perK, group = 1, colour = "E&W", 
                text = paste("Area: England and Wales",
                             "<br>Age of mother: ", age_mother,
  ...
  scale_color_manual(name='Geographical area:', values=c('London'='#943fab', 'E&W'='#5ea15d')) +
  theme(legend.title=element_text(size=14, family = "Arial"),
        legend.text=element_text(size=11, family = "Arial"),
        axis.text.x=element_text(color = "black", 
                                 size=11, family = "Arial"),  #, angle=30, vjust=.8, hjust=0.8
        axis.text.y=element_text(color = "black", size=11, family = "Arial")) +
  labs(title= "Age-specific fertility rate, London and England & Wales, 2021", 
     caption = paste0("Source: ONS, Chart: GLA demography"))

ggsave (filename = (paste0(chart_dir, "ASFR_London+allEandW_line.png")),
         plot = ASFR_London_allEandW_line,
         device = "png",
         dpi=600,
         width = 9,
         height = 5.56,
...
ASFR_London_allEandW_line_int <- ggplotly(ASFR_London_allEandW_line, tooltip = "text") %>%
  style(hoverlabel = list(bgcolor = "white")) %>%
  layout(title= list(x = 0.05, 
                     text = "<b>Age-specific fertility rate, London and England & Wales, 2021<b>", 
...
## Line plot of ASFR for inner and outer London and England and Wales
...
ASFR_London_zone_allEandW_lines <-
   ggplot() +
  theme_gla() +
  ...
  scale_x_continuous(breaks = c(20, 25, 30, 35, 40)) +  
   ...
   labs(title= "Age-specific fertility rate, London zone and England and Wales, 2021",
       caption = paste0("Source: ONS, Chart: GLA demography"))
ASFR_London_zone_allEandW_lines


ggsave (filename = (paste0(chart_dir, "ASFR_London_zone_allEandW_lines.png")),
         plot = ASFR_London_zone_allEandW_lines,
         device = "png",
         dpi=600,
         width = 9,
         height = 5.56,
...
## Line plot of TFR for London and England and Wales
...
TFR_London_allEandW_line <- merged_TFR_London_EandW %>%
  ggplot() +
  geom_line(aes(x = Year, y = London_TFR, group = 1, colour = "London", 
    ...
    geom_line(aes(x = Year, y = EandW_TFR, group = 1, colour = "E&W", 
                text = paste("Area: England and Wales",
                             "<br>Year: ", Year,
  ...
  theme(legend.title=element_text(size=14, family = "Arial"),
        ...
        axis.text.x=element_text(color = "black", 
                                 size=11, family = "Arial"),  #, angle=30, vjust=.8, hjust=0.8
        axis.text.y=element_text(color = "black", size=11, family = "Arial")) +
  labs(title= "Total fertility rate, London and England & Wales, 1993 - 2021", 
     caption = paste0("Source: ONS, Chart: GLA demography"))

ggsave (filename = (paste0(chart_dir, "TFR_London+allEandW_line.png")),
         plot = TFR_London_allEandW_line,
         device = "png",
         dpi=600,
         width = 9,
         height = 5.56,
...
TFR_London_allEandW_line_int <- ggplotly(TFR_London_allEandW_line, tooltip = "text") %>%
  style(hoverlabel = list(bgcolor = "white")) %>%
  layout(title= list(x = 0.05, 
                     text = "<b>Total fertility rate, London and England & Wales, 1993 - 2021<b>", 
                     font=list(size = 15, family = "Arial", color = "black", fontface = "bold")),
          legend=list(title=list(text='Area', font = list(size = 15, family = "Arial", color = "black", fontface = "bold"))), 
          # xaxis = list(title = list(text ='Age of mother', 
          #                          font = list(size = 15, family = "Arial", color = "black", 
...
TFR_London_zone_allEandW_lines <-
   ggplot() +
  theme_gla() +
...
ggsave (filename = (paste0(chart_dir, "TFR_London_zone_allEandW_lines.png")),
         plot = TFR_London_zone_allEandW_lines,
         device = "png",
         dpi=600,
         width = 9,
         height = 5.56,
